 ...
 */
final class Version20210310134928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clients CHANGE telephone telephone VARCHAR(13) NOT NULL, CHANGE num_cni num_cni VARCHAR(13) DEFAULT NULL');
    }
